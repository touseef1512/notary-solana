      ...
      <div className="w-full max-w-4xl px-4 mt-2 mb-6">
          ...
          <form className="flex flex-col gap-6">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div className="flex flex-col gap-2">
                <label htmlFor="comp-date" className="text-xs text-brand-muted">Event date</label>
                <input
                  id="comp-date"
                  type="date"
                  value={eventDate}
              ...
              <div className="flex flex-col gap-2">
                <label className="text-xs text-brand-muted">Event type</label>
        ...
        <div className="max-w-2xl mx-auto">
          {result.isEventDateWeekendOrHoliday && (
            <div className="mb-4 p-3 border border-brand-warning bg-brand-card flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-brand-warning shrink-0 mt-0.5" />
              <p className="text-brand-muted text-xs">
                <strong className="text-brand-warning block mb-1">Non-business day event</strong>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div className="border border-brand-border bg-brand-bg flex flex-col h-full">
              <div className="bg-brand-card border-b border-brand-border p-3">
                <h3 className="text-xs font-bold text-brand-muted text-center">Traditional (T+1)</h3>
              </div>
              <div className="p-6 flex flex-col items-center justify-center flex-1">
                ...
                <span className="text-xs text-brand-muted text-center max-w-[200px]">
            ...
            <div className="border border-brand-accent bg-brand-bg flex flex-col h-full">
              <div className="bg-brand-accent p-3">
                <h3 className="text-xs font-bold text-brand-card text-center">Solana (T+0)</h3>
              </div>
              <div className="p-6 flex flex-col items-center justify-center flex-1">
