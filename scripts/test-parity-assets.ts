...
KAMINO_PARITY_EXTRA.forEach((a) => {
  ...
  check("(5) " + a.symbol + " has a fixed risk-table gap", Object.prototype.hasOwnProperty.call(GAP_PERCENTAGES, a.symbol));
});
...
check("(8) every fixed-table symbol is a Kamino collateral symbol", Object.keys(GAP_PERCENTAGES).every((s) => KAMINO_COLLATERAL_SYMBOLS.indexOf(s) !== -1));
